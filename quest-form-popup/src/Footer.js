...
//       </div>
//       <div className="footer-contact">
//         <button className="contact-button" onClick={openPopupForm}>Contact With Sales</button>
//       </div>
//     </footer>
//   );
// };
...
const Footer = ({ openForm }) => {
    ...
    return (
        <footer className="footer">
            ...
            <div className="footer-contact">
                <button className="contact-button" onClick={openForm}>Connect With Sales</button>
            </div>
        </footer>
    );
};
